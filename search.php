...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light main_box">
	...
	<!-- End Banner Area -->
	<!--================Login Box Area =================-->
    <section id="shop" class="section_gap">
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					?>
						...
						<?php echo '<h1>Hasil Pencarian Dari "'.$keyword.'"</h1>'; ?>
						</div>
					</div>
				</div>
				<div class="row">
				<?php	
						$sth = $db->pdo->prepare("SELECT * FROM tbl_produk WHERE namaproduk LIKE '%$keyword%'");
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                                    <a href="productDetail.php?id=<?php echo $value->product_id;?>"><img class="img-fluid" src="<?php echo $value->fldimage;?>" alt=""></a>
                                        <div class="product-details">
                                        <a href="productDetail.php?id=<?php echo $value->product_id;?>"><h6><?php echo $value->namaproduk;?></h6></a>
                                            <div class="price">
                                                <h6><?php echo "Rp. ". number_format($value->harga); ?></h6>
                                            </div>
                                            <div class="prd-bottom">
                                                <a href="productDetail.php?id=<?php echo $value->product_id;?>" class="social-info">
