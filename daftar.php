  ...
  <nav class="navbar navbar-expand-lg navbar-light main_box">
	...
	<section class="login_box_area section_gap">
		<div class="container">
            ...
            ?>
						<form class="row login_form" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
              ...
              <div class="col-md-12 form-group">
								<input type="number" class="form-control" id="name" name="mobile" placeholder="No Tlp" onfocus="this.placeholder = ''" onblur="this.placeholder = 'No Tlp'">
							</div>
              <div class="col-md-12 form-group">
              <textarea class="form-control" name="address" id="Alamat" rows="1" placeholder="Enter Alamat" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Alamat'"></textarea>
							</div>

              <input type="hidden" name="roleid" value="2" class="form-control">

              <div class="col-md-12 form-group">
								<input type="file" class="form-control" id="Upload Foto" name="usr_img" placeholder="Upload Foto" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Upload Foto'">
							</div>
